...
public class AdminSearchParts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_search_parts);

        caseButton = findViewById(R.id.caseButton);
        caseButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 0);
            startActivity(intent);
        });

        moboButton = findViewById(R.id.moboButton);
        moboButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 1);
            startActivity(intent);
        });

        cpuButton = findViewById(R.id.cpuButton);
        cpuButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 2);
            startActivity(intent);
        });

        gpuButton = findViewById(R.id.gpuButton);
        gpuButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 3);
            startActivity(intent);
        });

        storageButton = findViewById(R.id.storageButton);
        storageButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 4);
            startActivity(intent);
        });

        memoryButton = findViewById(R.id.ramButton);
        memoryButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 5);
            startActivity(intent);
        });

        coolButton = findViewById(R.id.coolingButton);
        coolButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 6);
            startActivity(intent);
        });

        powerButton = findViewById(R.id.psuButton);
        powerButton.setOnClickListener(v -> {
            Intent intent = AdminViewParts.intentFactory(getApplicationContext(), 7);
            startActivity(intent);
        });
    }
